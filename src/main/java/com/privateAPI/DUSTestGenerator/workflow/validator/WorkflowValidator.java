...
public class WorkflowValidator
{
    ...
    public ConstraintViolationException validateForCorrectWorkflow(WorkflowGeneratorRequest workflowGeneratorRequest)
    {
        Set<ConstraintViolation<WorkflowGeneratorRequest>> violations = this.validator.validate(workflowGeneratorRequest);
        StringBuilder sb = new StringBuilder();
        ...
        if(workflowGeneratorRequest.getCountStaticPlace() == null)
        {
            isValid = false;
            sb.append("Pri generovaní korektnej workflow siete je potrebné zadať aj počet požadovaných statických miest");
            sb.append("\n");
        }
